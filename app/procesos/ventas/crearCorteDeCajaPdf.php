...
$fechaInit = date("Y-m-d", strtotime($_POST['fechaIngresoCorteDeCaja']));
$fechaFin  = date("Y-m-d", strtotime($_POST['fechaFinCorteDeCaja']));
...
$pdf->stream('corteDeCaja'.$fechaInit.'to'.$fechaFin.'.pdf');
